...
<body>
    <br>
    <h1 class="text-center">MAPA PEDIDOS </h1>
    <div class="col-md-4">
    ...
    <div class="row">
        ...
        <script type="text/javascript">
            function initMap() {
                ...
                <?php if ($mapaspe) : ?>
                    <?php foreach ($mapaspe as $lugarTemporal) : ?>
                        var coordenadaTemporal =
                            new google.maps.LatLng(<?php echo $lugarTemporal->latitud_ped; ?>, <?php echo $lugarTemporal->longitud_ped; ?>);
                        var marcador = new google.maps.Marker({
                            position: coordenadaTemporal,
                            title: "<?php echo $lugarTemporal->cod_ped; ?>",
                            icon: "<?php echo base_url(); ?>/assets/images/fle.png",
