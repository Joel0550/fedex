...
<body>
    <br>
    <h1 class="text-center">MAPA CLIENTES </h1>
    <div class="col-md-4">
    ...
    <div class="row">
        ...
        <script type="text/javascript">
            function initMap() {
                ...
                <?php if ($mapascli) : ?>
                    <?php foreach ($mapascli as $lugarTemporal) : ?>
                        var coordenadaTemporal =
                            new google.maps.LatLng(<?php echo $lugarTemporal->latitud_cli; ?>, <?php echo $lugarTemporal->longitud_cli; ?>);
